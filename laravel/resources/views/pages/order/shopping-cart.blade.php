...
<div class="container align-middle">
    <section class="container align-middle bg-white shadow-sm rounded-extra mt-5 mb-3 p-4">
        ...
        @else
            ...
            <form action="{{ route('shoppingCart.quantity',$orderProduct->id) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="col d-flex flex-column justify-content-between p-0 me-3">
                    <div class="row">
                        ...
                        <form class="closePart" action="{{ route('shoppingCart.destroy',$orderProduct->id) }}" method="post">
                            @method('delete')
                            @csrf
                    ...
                    <div class="row d-flex justify-content-between">
                        <div class="col-5 col-sm-4 col-md-3 col-lg-2 col-xxl-1">
                            ...
                            <input type="number" min="1" step="1" class="form-control amount-input" id="amount-input-1" name="quantity" value="{{ $orderProduct->quantity }}">
                        </div>
